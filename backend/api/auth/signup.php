...
// Body: { username, password, first_name, last_name, email, phone?, student_id? }
...
$stmt = $db->prepare(
    'INSERT INTO customers (username, password_hash, first_name, last_name, email, phone, student_id)
     VALUES (?, ?, ?, ?, ?, ?, ?)'
);
$stmt->execute([$username, $hash, $first_name, $last_name, $email, $phone, $student_id]);
